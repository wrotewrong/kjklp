...
const shoulderMarkDB = [
  ...
  },
  {
    positions: [
      ...
      'p.o. zastępcy nadleśniczego_DISTRICT',
      'p.o. zastępcy nadlesniczego_DISTRICT',
      'p.o. zastepcy nadleśniczego_DISTRICT',
      'p.o. zastepcy nadlesniczego_DISTRICT',
      'p. o. zastępcy nadleśniczego_DISTRICT',
      'p. o. zastępcy nadlesniczego_DISTRICT',
      'p. o. zastepcy nadleśniczego_DISTRICT',
      'p. o. zastepcy nadlesniczego_DISTRICT',
      'p.o. zastępca nadleśniczego_DISTRICT',
      'p.o. zastępca nadlesniczego_DISTRICT',
      'p.o. zastepca nadleśniczego_DISTRICT',
      'p.o. zastepca nadlesniczego_DISTRICT',
      'p. o. zastępca nadleśniczego_DISTRICT',
      'p. o. zastępca nadlesniczego_DISTRICT',
      'p. o. zastepca nadleśniczego_DISTRICT',
      'p. o. zastepca nadlesniczego_DISTRICT',
      'p.o. z-ca nadleśniczego_DISTRICT',
      'p.o. z-ca nadlesniczego_DISTRICT',
      'p.o. z-ca nadleśniczego_DISTRICT',
      'p.o. z-ca nadlesniczego_DISTRICT',
      'p. o. z-ca nadleśniczego_DISTRICT',
      'p. o. z-ca nadlesniczego_DISTRICT',
      ...
      'p.o. Głównego Księgowego_DISTRICT',
      'p.o. głównego księgowego_DISTRICT',
      'p.o. Głównej Księgowej_DISTRICT',
      'p.o. głównej księgowej_DISTRICT',
    ],
